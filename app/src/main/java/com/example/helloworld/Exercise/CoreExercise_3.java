...
public class CoreExercise_3 extends AppCompatActivity {
    ...
    private View coreSideParentView;
    private TextView  coreSideTV1, coreSideTV2,  coreSideTV3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), CoreExercise_3_video.class);
                startActivity(intent);
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), CoreExercise_3_text.class);
                startActivity(intent);
            }
        });
    ...
    private void initWidgets() {
        ...
        coreSideParentView = findViewById(R.id.coreSideParentView);
        coreSideTV1 = findViewById(R.id.coreSideTV1);
        coreSideTV2 = findViewById(R.id.coreSideTV2);
        coreSideTV3 = findViewById(R.id.coreSideTV3);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            coreSideTV1.setTextColor(white);
            coreSideTV2.setTextColor(white);
            coreSideTV3.setTextColor(white);
            timer_tv.setTextColor(white);
            coreSideParentView.setBackgroundColor(bgblack);

        }else{

            coreSideTV1.setTextColor(black);
            coreSideTV2.setTextColor(black);
            coreSideTV3.setTextColor(black);
            timer_tv.setTextColor(black);
            coreSideParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            coreSideTV1.setText("Side Plank");
            coreSideTV2.setText("View in Video");
            coreSideTV3.setText("View in Text");
            ...
            coreSideTV1.setText("Side Plank");
            coreSideTV2.setText("Tignan sa Bidyo");
            coreSideTV3.setText("Tignan sa Teksto");
    ...
    private void updateSizeView() {
        if(settings.getCustomSize().equals(ThemeSettings.SMALL_SIZE)){
            ...
            coreSideTV1.setTextSize(24);
            coreSideTV2.setTextSize(12);
            coreSideTV3.setTextSize(12);
            ...
            coreSideTV1.setTextSize(26);
            coreSideTV2.setTextSize(14);
            coreSideTV3.setTextSize(14);
            ...
            coreSideTV1.setTextSize(28);
            coreSideTV2.setTextSize(16);
            coreSideTV3.setTextSize(16);
