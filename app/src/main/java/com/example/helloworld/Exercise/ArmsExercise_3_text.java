...
public class ArmsExercise_3_text extends AppCompatActivity {

    ImageView bckBtn;

    private View armsTriangleTextParentView;
    private TextView armsTriangleTextTV, armsTriangleTextTV1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arms_exercise3_text);
    ...
    private void initWidgets() {
        ...
        armsTriangleTextParentView = findViewById(R.id.armsTriangleTextParentView);
        armsTriangleTextTV = findViewById(R.id.armsTriangleTextTV);
        armsTriangleTextTV1 = findViewById(R.id.armsTriangleTextTV1);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            armsTriangleTextTV.setTextColor(white);
            armsTriangleTextParentView.setBackgroundColor(bgblack);

        }else{

            armsTriangleTextTV.setTextColor(black);
            armsTriangleTextParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            armsTriangleTextTV.setText("Triangle Push Up");
            armsTriangleTextTV1.setText(R.string.arms_triangle);
            settings.setCustomLang(ThemeSettings.ENG_LANG);

        }else if (settings.getCustomLang().equals(ThemeSettings.TAG_LANG)){

            armsTriangleTextTV.setText("Tatsulok na Pagdiin-Angat");
            armsTriangleTextTV1.setText(R.string.arms_triangle_tag);
