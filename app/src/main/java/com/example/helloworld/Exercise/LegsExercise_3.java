...
public class LegsExercise_3 extends AppCompatActivity {
    ...
    private View legsDonkeyParentView;
    private TextView legsDonkeyTV1, legsDonkeyTV2, legsDonkeyTV3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legs_exercise3);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegsExercise_3_video.class);
                startActivity(intent);
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegsExercise_3_text.class);
                startActivity(intent);
            }
        });
    ...
    private void initWidgets() {
        ...
        legsDonkeyParentView = findViewById(R.id.legsDonkeyParentView);
        legsDonkeyTV1 = findViewById(R.id.legsDonkeyTV1);
        legsDonkeyTV2 = findViewById(R.id.legsDonkeyTV2);
        legsDonkeyTV3 = findViewById(R.id.legsDonkeyTV3);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            legsDonkeyTV1.setTextColor(white);
            legsDonkeyTV2.setTextColor(white);
            legsDonkeyTV3.setTextColor(white);
            timer_tv.setTextColor(white);
            legsDonkeyParentView.setBackgroundColor(bgblack);

        }else{

            legsDonkeyTV1.setTextColor(black);
            legsDonkeyTV2.setTextColor(black);
            legsDonkeyTV3.setTextColor(black);
            timer_tv.setTextColor(black);
            legsDonkeyParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            legsDonkeyTV1.setText("Donkey Kicks");
            legsDonkeyTV2.setText("View in Video");
            legsDonkeyTV3.setText("View in Text");
            start_btn.setText("START");
            settings.setCustomLang(ThemeSettings.ENG_LANG);

        }else if (settings.getCustomLang().equals(ThemeSettings.TAG_LANG)){

            legsDonkeyTV1.setText("Sipa ng Donkey");
            legsDonkeyTV2.setText("Tignan sa Bidyo");
            legsDonkeyTV3.setText("Tignan sa Teksto");
    ...
    private void updateSizeView() {
        if(settings.getCustomSize().equals(ThemeSettings.SMALL_SIZE)){
            ...
            legsDonkeyTV1.setTextSize(24);
            legsDonkeyTV2.setTextSize(12);
            legsDonkeyTV3.setTextSize(12);
            ...
            legsDonkeyTV1.setTextSize(26);
            legsDonkeyTV2.setTextSize(14);
            legsDonkeyTV3.setTextSize(14);
            ...
            legsDonkeyTV1.setTextSize(28);
            legsDonkeyTV2.setTextSize(16);
            legsDonkeyTV3.setTextSize(16);
