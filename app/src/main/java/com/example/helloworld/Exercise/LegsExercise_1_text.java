...
public class LegsExercise_1_text extends AppCompatActivity {

    ImageView bckBtn;

    //Theme SharedPreferences
    private View legsSquatTextParentView;
    private TextView legsSquatTextTV, legsSquatTextTV1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legs_exercise1_text);
    ...
    private void initWidgets() {
        ...
        legsSquatTextParentView = findViewById(R.id.legsSquatTextParentView);
        legsSquatTextTV = findViewById(R.id.legsSquatTextTV);
        legsSquatTextTV1 = findViewById(R.id.legsSquatTextTV1);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            legsSquatTextTV.setTextColor(white);
            legsSquatTextParentView.setBackgroundColor(bgblack);

        }else{

            legsSquatTextTV.setTextColor(black);
            legsSquatTextParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            legsSquatTextTV.setText("Jump Squats");
            legsSquatTextTV1.setText(R.string.jump_squats);
            settings.setCustomLang(ThemeSettings.ENG_LANG);

        }else if (settings.getCustomLang().equals(ThemeSettings.TAG_LANG)){

            legsSquatTextTV.setText("Squat Pagkatalon");
            legsSquatTextTV1.setText(R.string.jump_squats_tag);
