...
public class LegsExercise_1 extends AppCompatActivity {
    ...
    private View legsSquatParentView;
    private TextView legsSquatTV1, legsSquatTV2, legsSquatTV3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legs_exercise1);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), LegsExercise_1_text.class);
                startActivity(intent);
            }
        });
    ...
    private void initWidgets() {
        ...
        legsSquatParentView = findViewById(R.id.legsSquatParentView);
        legsSquatTV1 = findViewById(R.id.legsSquatTV1);
        legsSquatTV2 = findViewById(R.id.legsSquatTV2);
        legsSquatTV3 = findViewById(R.id.legsSquatTV3);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            legsSquatTV1.setTextColor(white);
            legsSquatTV2.setTextColor(white);
            legsSquatTV3.setTextColor(white);
            timer_tv.setTextColor(white);
            legsSquatParentView.setBackgroundColor(bgblack);

        }else{

            legsSquatTV1.setTextColor(black);
            legsSquatTV2.setTextColor(black);
            legsSquatTV3.setTextColor(black);
            timer_tv.setTextColor(black);
            legsSquatParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateSizeView() {
        if(settings.getCustomSize().equals(ThemeSettings.SMALL_SIZE)){
            ...
            legsSquatTV1.setTextSize(24);
            legsSquatTV2.setTextSize(12);
            legsSquatTV3.setTextSize(12);
            ...
            legsSquatTV1.setTextSize(26);
            legsSquatTV2.setTextSize(14);
            legsSquatTV3.setTextSize(14);
            ...
            legsSquatTV1.setTextSize(28);
            legsSquatTV2.setTextSize(16);
            legsSquatTV3.setTextSize(16);
