...
public class BodyExercise_2_text extends AppCompatActivity {

    ImageView bckBtn;

    //Theme SharedPreferences
    private View bodyClimbersTextParentView;
    private TextView bodyClimbersTextTV, bodyClimbersTextTV1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_exercise2_text);
    ...
    private void initWidgets() {
        ...
        bodyClimbersTextParentView = findViewById(R.id.bodyClimbersTextParentView);
        bodyClimbersTextTV = findViewById(R.id.bodyClimbersTextTV);
        bodyClimbersTextTV1 = findViewById(R.id.bodyClimbersTextTV1);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            bodyClimbersTextTV.setTextColor(white);
            bodyClimbersTextParentView.setBackgroundColor(bgblack);

        }else{

            bodyClimbersTextTV.setTextColor(black);
            bodyClimbersTextParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            bodyClimbersTextTV.setText("Burpee");
            bodyClimbersTextTV1.setText(R.string.burpee);
            settings.setCustomLang(ThemeSettings.ENG_LANG);

        }else if (settings.getCustomLang().equals(ThemeSettings.TAG_LANG)){

            bodyClimbersTextTV.setText("Burpee");
            bodyClimbersTextTV1.setText(R.string.burpee_tag);
