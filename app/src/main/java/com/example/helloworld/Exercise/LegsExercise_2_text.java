...
public class LegsExercise_2_text extends AppCompatActivity {

    ImageView bckBtn;

    //Theme SharedPreferences
    private View legsLungeTextParentView;
    private TextView legsLungeTextTV, legsLungeTextTV1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legs_exercise2_text);
    ...
    private void initWidgets() {
        ...
        legsLungeTextParentView = findViewById(R.id.legsLungeTextParentView);
        legsLungeTextTV = findViewById(R.id.legsLungeTextTV);
        legsLungeTextTV1 = findViewById(R.id.legsLungeTextTV1);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            legsLungeTextTV.setTextColor(white);
            legsLungeTextParentView.setBackgroundColor(bgblack);

        }else{

            legsLungeTextTV.setTextColor(black);
            legsLungeTextParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            legsLungeTextTV.setText("Reverse Lunge");
            legsLungeTextTV1.setText(R.string.reverse_lunge);
            settings.setCustomLang(ThemeSettings.ENG_LANG);

        }else if (settings.getCustomLang().equals(ThemeSettings.TAG_LANG)){

            legsLungeTextTV.setText("Reverse Lunge");
            legsLungeTextTV1.setText(R.string.reverse_lunge_tag);
