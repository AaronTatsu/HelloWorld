...
public class CoreExercise_2_text extends AppCompatActivity {

    ImageView bckBtn;

    //Theme SharedPreferences
    private View coreCrunchTextParentView;
    private TextView coreCrunchTextTV, coreCrunchTextTV1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_core_exercise2_text);
    ...
    private void initWidgets() {
        ...
        coreCrunchTextParentView = findViewById(R.id.coreCrunchTextParentView);
        coreCrunchTextTV = findViewById(R.id.coreCrunchTextTV);
        coreCrunchTextTV1 = findViewById(R.id.coreCrunchTextTV1);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            coreCrunchTextTV.setTextColor(white);
            coreCrunchTextParentView.setBackgroundColor(bgblack);

        }else{

            coreCrunchTextTV.setTextColor(black);
            coreCrunchTextParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            coreCrunchTextTV.setText("Bicycle Crunches");
            coreCrunchTextTV1.setText(R.string.bicycle_crunches);
            settings.setCustomLang(ThemeSettings.ENG_LANG);

        }else if (settings.getCustomLang().equals(ThemeSettings.TAG_LANG)){

            coreCrunchTextTV.setText("Mga Crunches ng Bisikleta");
            coreCrunchTextTV1.setText(R.string.bicycle_crunches_tag);
