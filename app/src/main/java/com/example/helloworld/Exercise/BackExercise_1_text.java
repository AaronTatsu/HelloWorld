...
public class BackExercise_1_text extends AppCompatActivity {
    ...
    private View backSuperYTextParentView;
    private TextView backSuperYTextTV, backSuperYTextTV1;
    ...
    private void initWidgets() {
        ...
        backSuperYTextParentView = findViewById(R.id.backSuperYTextParentView);
        backSuperYTextTV = findViewById(R.id.backSuperYTextTV);
        backSuperYTextTV1 = findViewById(R.id.backSuperYTextTV1);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            backSuperYTextTV.setTextColor(white);
            backSuperYTextParentView.setBackgroundColor(bgblack);

        }else{

            backSuperYTextTV.setTextColor(black);
            backSuperYTextParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            backSuperYTextTV.setText("Superman Y");
            backSuperYTextTV1.setText(R.string.back_supery);
            settings.setCustomLang(ThemeSettings.ENG_LANG);

        }else if (settings.getCustomLang().equals(ThemeSettings.TAG_LANG)){

            backSuperYTextTV.setText("Superman Y");
            backSuperYTextTV1.setText(R.string.back_supery_tag);
