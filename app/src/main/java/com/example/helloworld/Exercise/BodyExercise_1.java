...
public class BodyExercise_1 extends AppCompatActivity {
    ...
    private View bodyBurpeeParentView;
    private TextView bodyBurpeeTV1, bodyBurpeeTV2, bodyBurpeeTV3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_exercise1);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), BodyExercise_1_video.class);
                startActivity(intent);
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), BodyExercise_1_text.class);
                startActivity(intent);
            }
        });
    ...
    private void initWidgets() {
        ...
        bodyBurpeeParentView = findViewById(R.id.bodyBurpeeParentView);
        bodyBurpeeTV1 = findViewById(R.id.bodyBurpeeTV1);
        bodyBurpeeTV2 = findViewById(R.id.bodyBurpeeTV2);
        bodyBurpeeTV3 = findViewById(R.id.bodyBurpeeTV3);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            bodyBurpeeTV1.setTextColor(white);
            bodyBurpeeTV2.setTextColor(white);
            bodyBurpeeTV3.setTextColor(white);
            timer_tv.setTextColor(white);
            bodyBurpeeParentView.setBackgroundColor(bgblack);

        }else{

            bodyBurpeeTV1.setTextColor(black);
            bodyBurpeeTV2.setTextColor(black);
            bodyBurpeeTV3.setTextColor(black);
            timer_tv.setTextColor(black);
            bodyBurpeeParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateLangView() {
        if(settings.getCustomLang().equals(ThemeSettings.ENG_LANG)){
            ...
            bodyBurpeeTV1.setText("Burpee");
            bodyBurpeeTV2.setText("View in Video");
            bodyBurpeeTV3.setText("View in Text");
            ...
            bodyBurpeeTV1.setText("Burpee");
            bodyBurpeeTV2.setText("Tignan sa Bidyo");
            bodyBurpeeTV3.setText("Tignan sa Teksto");
    ...
    private void updateSizeView() {
        if(settings.getCustomSize().equals(ThemeSettings.SMALL_SIZE)){
            ...
            bodyBurpeeTV1.setTextSize(24);
            bodyBurpeeTV2.setTextSize(12);
            bodyBurpeeTV3.setTextSize(12);
            ...
            bodyBurpeeTV1.setTextSize(26);
            bodyBurpeeTV2.setTextSize(14);
            bodyBurpeeTV3.setTextSize(14);
            ...
            bodyBurpeeTV1.setTextSize(28);
            bodyBurpeeTV2.setTextSize(16);
            bodyBurpeeTV3.setTextSize(16);
