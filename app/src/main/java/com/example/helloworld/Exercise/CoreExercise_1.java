...
public class CoreExercise_1 extends AppCompatActivity {
    ...
    private View corePlankParentView;
    private TextView corePlankTV1, corePlankTV2, corePlankTV3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), CoreExercise_1_text.class);
                startActivity(intent);
            }
        });
    ...
    private void initWidgets() {
        ...
        corePlankParentView = findViewById(R.id.corePlankParentView);
        corePlankTV1 = findViewById(R.id.corePlankTV1);
        corePlankTV2 = findViewById(R.id.corePlankTV2);
        corePlankTV3 = findViewById(R.id.corePlankTV3);
    ...
    private void updateThemeView() {
        ...
        if(settings.getCustomTheme().equals(ThemeSettings.DARK_THEME)){
            ...
            corePlankTV1.setTextColor(white);
            corePlankTV2.setTextColor(white);
            corePlankTV3.setTextColor(white);
            timer_tv.setTextColor(white);
            corePlankParentView.setBackgroundColor(bgblack);

        }else{

            corePlankTV1.setTextColor(black);
            corePlankTV2.setTextColor(black);
            corePlankTV3.setTextColor(black);
            timer_tv.setTextColor(black);
            corePlankParentView.setBackgroundColor(bgwhite);
        }
    }
    ...
    private void updateSizeView() {
        if(settings.getCustomSize().equals(ThemeSettings.SMALL_SIZE)){
            ...
            corePlankTV1.setTextSize(24);
            corePlankTV2.setTextSize(12);
            corePlankTV3.setTextSize(12);
            ...
            corePlankTV1.setTextSize(26);
            corePlankTV2.setTextSize(14);
            corePlankTV3.setTextSize(14);
            ...
            corePlankTV1.setTextSize(28);
            corePlankTV2.setTextSize(16);
            corePlankTV3.setTextSize(16);
